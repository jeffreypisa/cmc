...
class StarterSite extends TimberSite {
	...
	function add_to_context( $context ) {
		...
		$context['footermenu_marketing'] = new TimberMenu('footermenu_marketing');
		$context['footermenu_media'] = new TimberMenu('footermenu_media');
    ...
    $zalen = Timber::get_posts( $zalenargs );
